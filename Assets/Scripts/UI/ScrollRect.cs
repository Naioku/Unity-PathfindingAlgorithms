...
namespace UI
{
        ...
        ILayoutGroup
    {
        ...
        [SerializeField]
        private UnityEngine.UI.ScrollRect.MovementType m_MovementType = UnityEngine.UI.ScrollRect.MovementType.Elastic;

        /// <summary>
        /// The behavior to use when the content moves beyond the scroll rect.
        /// </summary>
        public UnityEngine.UI.ScrollRect.MovementType movementType { get { return m_MovementType; } set { m_MovementType = value; } }
        ...
        /// </summary>
        public UnityEngine.UI.ScrollRect.ScrollbarVisibility horizontalScrollbarVisibility { get { return m_HorizontalScrollbarVisibility; } set { m_HorizontalScrollbarVisibility = value; SetDirtyCaching(); } }
        ...
        /// </summary>
        public UnityEngine.UI.ScrollRect.ScrollbarVisibility verticalScrollbarVisibility { get { return m_VerticalScrollbarVisibility; } set { m_VerticalScrollbarVisibility = value; SetDirtyCaching(); } }
        ...
        void UpdateCachedData()
        {
            ...
            m_HSliderExpand = allAreChildren && m_HorizontalScrollbarRect && horizontalScrollbarVisibility == UnityEngine.UI.ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport;
            m_VSliderExpand = allAreChildren && m_VerticalScrollbarRect && verticalScrollbarVisibility == UnityEngine.UI.ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport;
        ...
        protected override void OnEnable()
        {
            ...
            if (m_HorizontalScrollbar)
                m_HorizontalScrollbar.OnValueChanged += SetHorizontalNormalizedPosition;
            if (m_VerticalScrollbar)
                m_VerticalScrollbar.OnValueChanged += SetVerticalNormalizedPosition;
        ...
        public virtual void OnScroll(PointerEventData data)
        {
            ...
            if (m_MovementType == UnityEngine.UI.ScrollRect.MovementType.Clamped)
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            position += offset;
            if (m_MovementType == UnityEngine.UI.ScrollRect.MovementType.Elastic)
            {
                if (offset.x != 0)
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (!m_Dragging && (offset != Vector2.zero || m_Velocity != Vector2.zero))
            {
                ...
                for (int axis = 0; axis < 2; axis++)
                {
                    ...
                    if (m_MovementType == UnityEngine.UI.ScrollRect.MovementType.Elastic && offset[axis] != 0)
                    {
        ...
        private static void UpdateOneScrollbarVisibility(bool xScrollingNeeded, bool xAxisEnabled, UnityEngine.UI.ScrollRect.ScrollbarVisibility scrollbarVisibility, Scrollbar scrollbar)
        {
            if (scrollbar)
            {
        ...
        private static Vector2 InternalCalculateOffset(ref Bounds viewBounds, ref Bounds contentBounds, bool horizontal, bool vertical, UnityEngine.UI.ScrollRect.MovementType movementType, ref Vector2 delta)
        {
